...
if __name__ == "__main__":   
    ...
    parser.add_argument("--process_name", default="PREPARE_CLIPSEQ:RESOLVE_UNANNOTATED")   
    ...
    parser.add_argument("--output", default="Homo_sapiens_filtered_seg_genicOtherfalse.resolved.gtf")   
