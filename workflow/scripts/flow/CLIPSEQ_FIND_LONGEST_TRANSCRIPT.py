...
if __name__ == "__main__":   
    ...
    parser.add_argument("--process_name", default="PREPARE_CLIPSEQ:CLIPSEQ_FIND_LONGEST_TRANSCRIPT")   
    parser.add_argument("--gtf", default="Homo_sapiens.GRCh38.109_bracketsremoved.cmd.gtf")   
    parser.add_argument("--output", default="longest_transcript")   
