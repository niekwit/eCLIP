...
if __name__ == "__main__":   
    ...
    parser.add_argument("--process_name", default="PREPARE_CLIPSEQ:RESOLVE_UNANNOTATED_GENIC_OTHER")   
    parser.add_argument("--segmentation", default="Homo_sapiens_seg.gtf")   
    parser.add_argument("--filt_segmentation", default="Homo_sapiens_filtered_seg.gtf")   
    ...
    parser.add_argument("--output", default="Homo_sapiens_filtered_seg_genicOthertrue.resolved.gtf")   
