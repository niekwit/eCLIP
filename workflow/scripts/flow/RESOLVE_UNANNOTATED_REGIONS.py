...
if __name__ == "__main__":   
    ...
    parser.add_argument("--process_name", default="PREPARE_CLIPSEQ:RESOLVE_UNANNOTATED_REGIONS")   
    ...
    parser.add_argument("--genic_other", default="false")   
    parser.add_argument("--output", default="Homo_sapiens_filtered_regions_genicOtherfalse.resolved.gtf")   
