...
if __name__ == "__main__":   
    ...
    parser.add_argument("--process_name", default="PREPARE_CLIPSEQ:RESOLVE_UNANNOTATED_GENIC_OTHER_REGIONS")   
    parser.add_argument("--segmentation", default="Homo_sapiens_regions.gtf.gz")   
    parser.add_argument("--filt_segmentation", default="Homo_sapiens_filtered_regions.gtf.gz")   
    parser.add_argument("--annotation", default="Homo_sapiens.GRCh38.109_bracketsremoved.cmd.gtf")   
    parser.add_argument("--fai", default="Homo_sapiens.GRCh38.fasta.fai")   
    parser.add_argument("--genic_other", default="true")   
    parser.add_argument("--output", default="Homo_sapiens_filtered_regions_genicOthertrue.resolved.gtf")   
